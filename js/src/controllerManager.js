...
ZY.controllerManager=(function(){
    ...
    return {
        ...
        init:function(){
            ...
            winH=$(window).height();
            landScapeY=$("#zy_landscape").offset().top;
            peopleY=$("#zy_people").offset().top;
            artifactY=$("#zy_artifact").offset().top;
            communityY=$("#zy_community").offset().top;
            footerY=$(".zy_footer").offset().top;
        },
