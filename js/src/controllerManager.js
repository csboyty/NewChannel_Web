...
ZY.controllerManager={
    ...
    windowResizeHandler:function(){
        ...
        ZY.dataManager.resizeTimer=setTimeout(function(){
            me.doResizeOfCategory($("#zy_people_contain"),ZY.config.articleWidths.peopleWidth,
                ZY.dataManager.peopleLoaded);
            me.doResizeOfCategory($("#zy_landscape_contain"),ZY.config.articleWidths.landscapeWidth,
                ZY.dataManager.landscapeLoaded);
            me.doResizeOfCategory($("#zy_community_contain"),ZY.config.articleWidths.communityWidth,
                ZY.dataManager.communityLoaded);
            me.doResizeOfCategory($("#zy_artifact_contain"),ZY.config.articleWidths.artifactWidth,
